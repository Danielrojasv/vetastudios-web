...
<head>
    ...
    <style>
        :root {
            ...
            --accent-color: #E63946;
            --border-color: #2B2D42;
            --card-bg: #111111; /* Cambiado a #111111 para las cards */
        }
        ...
        * {
        ...
        .project-card {
            background-color: var(--card-bg);
            border: 1px solid #222222; /* Borde de las cards */
            border-radius: 8px;
            padding: 30px;
        ...
        .tag {
            font-size: 0.75rem;
            padding: 4px 10px;
            background-color: #222222; /* Fondo de los tags */
            border-radius: 4px;
            color: #D0D0D0;
            font-family: monospace;
        }
        ...
        .service-card {
            background-color: #111111; /* Fondo de las cards */
            border: 1px solid #222222; /* Borde de las cards */
            border-radius: 8px;
            padding: 20px;
            text-align: center;
        ...
        .service-card svg {
            width: 50px;
            height: 50px;
            fill: #ffffff; /* Color del ícono SVG */
        }
