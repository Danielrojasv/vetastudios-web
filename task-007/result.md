...
<head>
    ...
    <style>
        ...
        * {
        ...
        .services-section, .clients-section, .contact-section {
            margin-bottom: 80px;
        }

        .services-section h3, .clients-section h3, .contact-section h3 {
            font-size: 1.2rem;
            text-transform: uppercase;
            letter-spacing: 2px;
            color: #666;
        ...
        <main>
            ...
            <section id="services" class="services-section">
                ...
                <div class="services-grid">
                    <div class="service-card">
                        ...
                        <p>Aplicaciones web y móviles con arquitecturas escalables, utilizando tecnologías modernas y prácticas de ingeniería de software.</p>
                    </div>
                    <div class="service-card">
                        <h4>Consultoría Técnica</h4>
                        <p>Asesoramiento en arquitectura de sistemas, optimización de infraestructura y solución de problemas técnicos complejos.</p>
                    </div>
                    <div class="service-card">
                        <h4>Productos Digitales</h4>
                        <p>Diseño y desarrollo de productos digitales desde cero, con enfoque en experiencia de usuario y valor funcional.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="clients" class="clients-section">
                ...
                <div class="clients-grid">
                    <div>
                        <img src="client1.png" alt="Cliente 1" class="client-logo">
                    </div>
                    <div>
                        <img src="client2.png" alt="Cliente 2" class="client-logo">
                    </div>
                    <div>
                        <img src="client3.png" alt="Cliente 3" class="client-logo">
                    </div>
                    <div>
                        <img src="client4.png" alt="Cliente 4" class="client-logo">
                    </div>
                </div>
            </section>
