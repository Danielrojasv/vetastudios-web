            ...
            <section class="clients-section">
                ...
                <div class="clients-grid">
                    <div class="client-card">
                        <h4>Mercado Libre</h4>
                        <p>Desarrollo de microservicios para optimización de rutas de entrega en zonas rurales utilizando algoritmos de grafos y machine learning.</p>
                    </div>
                    <div class="client-card">
                        <h4>Falabella Tecnología</h4>
                        <p>Implementación de arquitectura serverless para procesamiento de datos en tiempo real en su plataforma de comercio electrónico.</p>
                    </div>
                    <div class="client-card">
                        <h4>CrediTú</h4>
                        <p>Diseño e implementación de motor de scoring crediticio basado en modelos predictivos y análisis de big data.</p>
                    </div>
                </div>
            </section>
        </main>
